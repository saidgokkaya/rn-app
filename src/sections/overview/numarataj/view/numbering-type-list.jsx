...
import { UseTableRow } from '../filter-table-row';
import { TableToolbar } from '../filter-table-toolbar';
import { TableFiltersResult } from '../filter-table-filters-result';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`${CONFIG.apiUrl}/Numarataj/numberings-for-type?numType=${type}`, {
          method: 'GET',
          headers: {
